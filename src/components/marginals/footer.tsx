  ...
  return (
    <main className="min-h-screen mt-50 w-full flex flex-col justify-end relative">
      <div className="w-full flex flex-col justify-between items-center px-4 sm:px-6 md:px-8 lg:px-18 pt-6 mb-8 lg:mb-35">
        <div className="hidden min-[960px]:flex w-full flex-row justify-between items-center">
        ...
        <div className="grid grid-cols-4 gap-x-6 gap-y-6 min-[960px]:hidden px-8 sm:px-6 md:px-8">
          <a
            href="https://instagram.com/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <Instagram className="w-6 h-6" />
            <Typography.H6 className="text-28px sm:text-[30px] md:text-[32px] lg:text-[34px] px-4 sm:px-6 md:px-8 leading-none">
              INSTAGRAM
            </Typography.H6>
          </a>
          <div /> {/* empty */}
          ...
          >
            ...
            <Typography.H6 className="text-28px sm:text-[30px] md:text-[32px] lg:text-[34px] leading-none">
              TWITTER
            </Typography.H6>
          </a>
          <div />
      ...
      <main className="relative  flex flex-col justify-between min-h-screen">
        <div className="absolute lg:bottom-[2%] w-full px-4 sm:px-8 lg:px-20">
          <div className="flex justify-between items-end w-full">
            <div className="flex items-center gap-2 relative 2xl:top-[-40px] lg:bottom-[6%] sm:gap-3">
              <span className="text-base sm:text-lg lg:text-[30px] leading-none relative top-[-12px] sm:top-[-12px] lg:top-[-9px]">
                ©
              </span>
            ...
            <Typography.Lead className="text-xs relative 2xl:top-[-40px] lg:bottom-[6%] sm:mt-5 sm:text-sm lg:text-lg  text-black text-right leading-snug">
