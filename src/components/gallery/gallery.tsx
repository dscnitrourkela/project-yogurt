...
import { textItems } from '@/config/gallery/background';
import { text } from '@/config/gallery/background';

export default function Gallery() {
  return (
    <div className=" relative w-full -z-10 overflow-hidden bg-[#181818]">
      <div className="flex flex-row px-[5vw] py-[15vh] z-10">
        {/* Left Column */}
              ...
              <div key={index} className="flex flex-col items-center">
                {item.text.split('').map((char, charIndex) => (
                  <div
                    key={charIndex}
                    className={`
                              text-[#E2E2E2] text-center text-[1.7vw] sm:text-[1.2vw] md:text-[0.9vw] leading-snug
